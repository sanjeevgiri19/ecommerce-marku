...
const Home = () => {
  ...
  useEffect(() => {
    if (!filteredProducts || category == "undefined" ) setfilteredProducts(products);   //if filteredproduct ko value xaina or category undefined xa vane setfilteredproduct ma products halne
