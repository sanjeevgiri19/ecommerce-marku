        ...
        <div className="w-[80%] h-full flex">
          <div className="pt-44 pl-64 flex ">
            ...
            <div className="ml-10 mt-6 w-[75%] h-2/3 ">
              ...
              <div>
                <Link className="mr-3  px-4 py-1 border border-blue-400 text-blue-500">Edit</Link>
                <Link className="  px-4 font-medium py-1 border border-red-400 text-red-500">Delete</Link>
              </div>
